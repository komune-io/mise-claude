...
impl Lockfile {
    ...
    /// Iterate `(name, &LockedTool)` for a section (empty if absent).
    pub fn section_entries<'a>(&'a self, section: &str) -> Vec<(String, &'a LockedTool)> {
        self.sections
            .get(section)
    ...
    pub fn serialize(&self) -> String {
        let header = "# Auto-generated by chord. Do not edit.\n\n";
